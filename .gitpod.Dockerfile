...
LABEL io.nullables.charts.build-date=$BUILD_DATE
LABEL io.nullables.charts.name="charts"
LABEL io.nullables.charts.description="Styled charts"
LABEL io.nullables.charts.url="https://nullables.io/"
LABEL io.nullables.charts.vcs-ref=$VCS_REF
LABEL io.nullables.charts.vcs-url="https://github.com/AlexRogalskiy/charts"
LABEL io.nullables.charts.vendor="Nullables.io"
LABEL io.nullables.charts.version=$VERSION
